...
import {Box, Card, Grid, Heading, Input, Label, Text} from 'theme-ui';
    ...
    <Box p={[2, 2]}>
      ...
      <Box p={2}>
        <Grid width={[1, 1]} mb={2}>
          ...
          <Box>
            <Label htmlFor="processing">Usuários</Label>
            <Input value={users} type="number" min="0" name="processing" onChange={e => setUsers(e.target.value)}/>
          </Box>
        </Grid>
      </Box>
